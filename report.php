...
<body>
    <div class="container">
        <h3 class="mb-3 mt-3">All View</h3>
        <form action="rep.php" method="post" id="registration">
            <div class="form-group dropdown mb-3 col-md-5">
                <label for="vty">Vehicle Type</label>
            ...
            <button type="submit" class="btn btn-outline-success mb-3" name="submt1" id="submit">Submit</button>
        </form>
    </div>
    <script>
